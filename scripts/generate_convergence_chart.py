...
def generate_convergence_data(num_seeds: int = 10, count_per_seed: int = 500) -> list[dict[str, Any]]:
...
def main() -> None:
    ...
    parser.add_argument("--output", default="reports/coverage_convergence.csv", help="Output CSV path")
    parser.add_argument("--report", default="reports/coverage_convergence.md", help="Output report path")
