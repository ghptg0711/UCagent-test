...
{
public:
    SNutShellCache *top = nullptr; // GSim Top Module
private:
...
public:
    ...
    std::string sv_scope = "TOP.NutShellCache_top";
    void *top;
    void init(int, char **);
    DutVerilatorBase();
...
void finish_PfBDHOhl2mS();
void vcs_fsdb_set_waveform_PfBDHOhl2mS(const char *filename);
void vcs_fsdb_finish_waveform_PfBDHOhl2mS();
void vcs_fsdb_flush_waveform_PfBDHOhl2mS();
void vcs_fsdb_waveform_enable_PfBDHOhl2mS(unsigned char enable);
void vcs_coverage_start_PfBDHOhl2mS();
void vcs_coverage_stop_PfBDHOhl2mS();
void vcs_coverage_reset_PfBDHOhl2mS();
void vcs_coverage_dump_PfBDHOhl2mS(const char *filename);
}
#include "vc_hdrs.h"
...
public:
    std::string sv_scope = "NutShellCache_top";
    void init(int, char **);
